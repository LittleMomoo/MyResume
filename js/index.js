$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫汤亚玲，是辽宁大学软件工程专业的一名学生</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我想应聘的岗位是软件工程师</div>",2000);
	...
	w.load("<p><div class='writecode'>汤亚玲</div>");
	w.load("<div class='writecode'>软件工程师</div>");
	w.load("<div class='writecode'></div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:843848778@qq.com</li>");
	w.load("<li class='writecode'>phone:15040165358</li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/LittleMomoo' target='_blank'>https://github.com/LittleMomoo</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>熟练java语言,C语言，熟练运用spring框架</li>");
	w.load("<li class='writecode'>熟练Web前端开发技术H5,CSS3</li>");
	w.load("<li class='writecode'>熟练Mysql</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>经验</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>个人通讯录制作</li>");
	w.load("<li class='writecode'>图书管理系统</li>");
	w.load("<li class='writecode'></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>校内经验</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>多次获得学校奖学金</li>");
	w.load("<li class='writecode'>优秀学生称号</li>");
	w.load("<li class='writecode'>老乡会会长</li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*最后非常感谢您愿意看完我的简历！</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
